...
See [Named sandboxes & persistent stop](/docs/concepts/named-sandboxes/) for the full mechanics, and [Snapshots, resume, and fork](/docs/concepts/snapshots/) for what "resumed" actually does to the sandbox's state.
