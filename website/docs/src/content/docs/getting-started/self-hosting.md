...
Once you have an id back, move on to your language of choice: [JS/TS](/docs/getting-started/js/), [Python](/docs/getting-started/python/), or the [CLI](/docs/getting-started/cli/).
